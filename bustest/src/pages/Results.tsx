    ...
    return (
        <main style={{ maxWidth: 1100, margin: '0 auto', padding: '2rem 1.5rem' }}>
            <div style={{ marginBottom: '1.5rem' }}>
                ...
                {/* A11Y BUG: Low contrast help text — WCAG 1.4.3 */}
                <p style={{ color: '#e0e0e5', marginTop: '0.25rem' }}>{BUSES.length} buses available — scroll to view all options</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {BUSES.map((bus, i) => (
                    <motion.div key={bus.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.07 }}
                        ...
                        <div>
                            {/* A11Y BUG: Decorative image without alt — WCAG 1.1.1 */}
                            <img src="https://placehold.co/40x40/d52b1e/white?text=🚌" style={{ width: 40, height: 40, borderRadius: 8, marginBottom: '0.5rem' }} />
