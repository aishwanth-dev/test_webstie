        ...
        <main>
                ...
                {modalOpen && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                        ...
                        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }}
                            ...
                            {/* A11Y BUG: Login form inputs without labels — WCAG 1.3.1 / 4.1.2 */}
            ...
            <section style={{ background: 'linear-gradient(180deg, #fff7f7 0%, #ffffff 100%)', padding: '3rem 1.5rem 2rem', textAlign: 'center', borderBottom: '1px solid #e2e8f0' }}>
                <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                    ...
                    {/* A11Y BUG: Heading skip — h1 then h4 in hero — WCAG 1.3.1 */}
                    ...
                    <h4 style={{ color: '#94a3b8', fontSize: '0.9rem', fontWeight: 500 }}>Your trusted bus booking partner since 2020</h4>
                    ...
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr 1.2fr auto auto', gap: '1rem', alignItems: 'end', flexWrap: 'wrap' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                {/* A11Y BUG: Label not connected via htmlFor — WCAG 1.3.1 */}
            ...
            <section style={{ maxWidth: 1100, margin: '2rem auto', padding: '0 1.5rem' }}>
                {/* A11Y BUG: Low contrast text — WCAG 1.4.3 */}
                <h2 style={{ fontSize: '1.4rem', fontWeight: 900, marginBottom: '1rem', color: '#0f172a' }}>Popular Routes</h2>
                <p style={{ color: '#e8e8ea', fontSize: '0.85rem', marginBottom: '1rem' }}>Browse our most booked routes with exclusive discounts</p>
                {/* A11Y BUG: Clickable divs not keyboard accessible — WCAG 2.1.1 */}
